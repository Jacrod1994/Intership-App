...
/*** ALL QUIZ DATA IS STORED IN MULTI-DIMENSIONAL ARRAYS BELOW***/
        ...
        var OpinionQuiz = [
 ['Which one of the four pattents belong to the Opinion concept?',, ['Describing','Interacting','Drawing conclusions','Judging'], 4],
 ['Which one of the four pattents belong to the Opinion concept?',, ['Interpreting','Discerning','Comparing','Planning'], 1],
 ['How many devlopment patten dose the Opinion concept have?',, ['Two','Three','Four','Five'], 1],
 ['What is does this concept mean: Opinion?',, ['Draw personal opinions','Make a supposition','Interpret data','Personal judgment of actions'], 4],
 ['What is does this devlopment pattern mean: Judging?',, ['Interpret data','Draw personal opinions','Personal judgment of actions','Make a supposition'], 2],
 ['What is does this devlopment pattern mean: Interpreting?',, ['Make a supposition','Personal judgment of actions','Interpret data','Draw personal opinions'], 3],
 ['Expression of own _______',, ['Data','Judgment','Decisions','Opinions'], 2],
 ['This Pattern confirms that the learner can draw personal ________',, ['Opinions','Data','Judgment','Decisions'], 1],
 ['The "Interpreting" pattern demonstrates that the learner can either interpret_________',, ['Decisions','Opinions','Data','Judgment'], 3],
 ['This concept can also demonstrate personal judgment of actions or_______',, ['Data','Judgmen','Opinions','Decisions'], 4],
];
